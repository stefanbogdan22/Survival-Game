...
public:
    ...
    friend istream& operator>>(istream& in, individ& indiv);
    ///suprascriere operator =
    individ& operator= (const individ &indiv);
};

istream& operator>>(istream& in, individ& indiv){

    in>>indiv.nume_specie>>indiv.varsta>>indiv.energie>>indiv.viu;
...
///suprasriere operator =
individ& individ::operator=(const individ &indiv){

    nume_specie=indiv.nume_specie;
    varsta=indiv.varsta;
    energie=indiv.energie;
    viu=indiv.viu;
